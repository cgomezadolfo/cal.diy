...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Agenda Systemlabs";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "soporte@systemlabs.cl";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Agenda Systemlabs";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Agenda";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Agenda Systemlabs";
